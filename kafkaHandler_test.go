...
func TestConfigKafka(t *testing.T) {
	...
	expectedProducerTopic := []string{"goroutine-channel", "channelKafka"}
	expectedConsumerTopics := []string{"goroutine-biller", "kafkaBiller"}
	...
	if producerTopic[1] != expectedProducerTopic[1] {
